...
const TransferMoney: React.FC = () => {
  ...
  return (
    <IonModal cssClass="transfer-money-modal" isOpen={true}>
      <IonRouterOutlet>
        ...
        <Route exact path={rootPath}>
          <IonPage>
            ...
            <IonContent className="ion-padding transfer-money-content">
              <p style={{fontSize:"1rem", fontWeight:700, color:"#267ae4"}}>From</p>
              ...
              <IonList>
                <p style={{fontSize:"1rem", fontWeight:700, color:"#267ae4"}}>To</p>
                {/* WALLET ITEM */}
                <SelectWalletPopover
                  wallet={toWallet!}
              ...
              <IonList>
                <p style={{fontSize:"1rem", fontWeight:700, color:"#267ae4"}}>Options</p>
                <IonItem lines="none">
                  <IonCheckbox
