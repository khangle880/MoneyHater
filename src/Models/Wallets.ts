...
export function switchWalletState(user_id: string, wallet: Wallet) {
  ...
  firestore
    ...
    .collection("wallets")
    .doc(wallet.id)
    .update({ state: wallet.state });
}

export function deleteWallet(user_id: string, wallet: Wallet) {
  ...
  const fake_fake = {
          ...
          transactions: [
            {
              ...
              with: "hieu",
              event: "1",
              remind: "2021-06-18T16:17:38.595Z",
              exclude_from_report: true,
              executed_time: "2021-06-18T16:17:28.111Z",
              transactions_list: [
                {
                  id: "94961",
                  amount: 10000,
    ...
    transactions: [
        ...
        transactions_list: [
          {
            ...
            with: "hieu",
            event: "1",
            remind: "2021-05-18T16:17:38.595Z",
            exclude_from_report: true,
            executed_time: "2021-06-18T16:17:28.111Z",
          },
          {
      ...
      },
      {
        ...
        with: "hieu",
        event: "31729",
        remind: "2021-05-18T14:17:38.595Z",
        exclude_from_report: true,
        executed_time: "2021-05-18T16:17:28.111Z",
        transactions_list: [
          {
            id: "87077",
            amount: 10000,
    ...
    recurring_transactions: [
      {
        ...
        with: "hieu",
        event: "1",
        remind: "2021-06-24T16:17:38.595Z",
        exclude_from_report: true,
        from: "2021-06-18T16:17:38.595Z",
        to: "2021-06-28T16:17:38.595Z",
        frequency: 2,
